...
| FLOW-02 | 02-02 | Form selection enforces supported version-pinned forms and minimum-one persistence into workflow. | passed | `lib/features/inspection/presentation/new_inspection_page.dart`, `test/features/inspection/new_inspection_page_test.dart` |
