...
| AUTH-04 | 01-03 | Inspector profile stores license type and license number for signed report identity. | passed | `lib/features/identity/data/inspector_profile_repository.dart`, `test/features/identity/inspector_profile_repository_test.dart` |
| AUTH-05 | 01-03 | Inspector signature capture/save/load persists signature evidence for report signing. | passed | `lib/features/identity/data/signature_repository.dart`, `test/features/identity/signature_repository_test.dart` |
