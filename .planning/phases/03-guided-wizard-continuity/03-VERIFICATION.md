...
| FLOW-05 | 03-guided-wizard-continuity-02-PLAN.md | Per-form checklist summary exposes missing required items before completion/PDF actions. | passed | `lib/features/inspection/presentation/form_checklist_page.dart`, `test/features/inspection/form_checklist_page_test.dart` |
